...
trabajos2=trabajos2[, c("folioviv", "foliohog", "numren", "tipo_trab1", "ocupa1", "tipo_trab2", "ocupa2", "trab" )]
...
trabajos2=trabajos2[, c("folioviv", "foliohog", "numren", "tipo_trab1", "ocupa1", "tipo_trab2", "inclab2", "aforlab2", "ocupa2", "trab" )]
trabajos2 <- orderBy(~+folioviv+foliohog+numren, data=trabajos2)
...
poblacion=poblacion[, c( "folioviv", "foliohog", "numren", "pea", "jub", "ss_dir", "par", "jef_ss", "cony_ss", "hijo_ss", "s_salud", "pam", "ic_segsoc")]
poblacion <- orderBy(~+folioviv+foliohog+numren, data=poblacion)
...
hogares2=hogares2[, c( "folioviv","foliohog", "tot_resid", "num_cuarto", "icv_pisos", "icv_techos", "icv_muros", "icv_hac", "ic_cv")]
...
attach(hogares)
hogares=hogares[, c("folioviv", "isb_agua", "isb_dren", "isb_luz", "isb_combus", "ic_sbv")]
hogares <- orderBy(~+folioviv, data=hogares)
...
attach(hogares)
hogares=hogares[, c( "folioviv", "foliohog","id_men" , "ia_1ad" , "ia_2ad" , "ia_3ad" ,"ia_4ad" , "ia_5ad", "ia_6ad","ia_7men" , "ia_8men" , "ia_9men","ia_10men" , "ia_11men","ia_12men", "tot_iaad", "tot_iamen", "ins_ali", "ic_ali" )]
hogares <- orderBy(~+folioviv+foliohog, data=hogares)
...
attach(trabajos2)
aguinaldo=trabajos2[,c( "folioviv", "foliohog", "numren" , "aguinaldo1" , "aguinaldo2" , "trab")]
...
ingresos$ing_6[(is.na(mes_6==2)!=TRUE & mes_6==2 & is.na(ingresos$ing_6)!=TRUE)]=ingresos$ing_6[(is.na(mes_6==2)!=TRUE & mes_6==2 & is.na(ingresos$ing_6)!=TRUE)]/feb16
ingresos$ing_6[(is.na(mes_6==3)!=TRUE & mes_6==3 & is.na(ingresos$ing_6)!=TRUE)]=ingresos$ing_6[(is.na(mes_6==3)!=TRUE & mes_6==3 & is.na(ingresos$ing_6)!=TRUE)]/mar16
ingresos$ing_6[(is.na(mes_6==4)!=TRUE & mes_6==4 & is.na(ingresos$ing_6)!=TRUE)]=ingresos$ing_6[(is.na(mes_6==4)!=TRUE & mes_6==4 & is.na(ingresos$ing_6)!=TRUE)]/abr16
ingresos$ing_6[(is.na(mes_6==5)!=TRUE & mes_6==5 & is.na(ingresos$ing_6)!=TRUE)]=ingresos$ing_6[(is.na(mes_6==5)!=TRUE & mes_6==5 & is.na(ingresos$ing_6)!=TRUE)]/may16
ingresos$ing_6[(is.na(mes_6==6)!=TRUE & mes_6==6 & is.na(ingresos$ing_6)!=TRUE)]=ingresos$ing_6[(is.na(mes_6==6)!=TRUE & mes_6==6 & is.na(ingresos$ing_6)!=TRUE)]/jun16

ingresos$ing_5[(is.na(mes_5==3)!=TRUE & mes_5==3 & is.na(ingresos$ing_5)!=TRUE)]=ingresos$ing_5[(is.na(mes_5==3)!=TRUE & mes_5==3 & is.na(ingresos$ing_5)!=TRUE)]/mar16
ingresos$ing_5[(is.na(mes_5==4)!=TRUE & mes_5==4 & is.na(ingresos$ing_5)!=TRUE)]=ingresos$ing_5[(is.na(mes_5==4)!=TRUE & mes_5==4 & is.na(ingresos$ing_5)!=TRUE)]/abr16
ingresos$ing_5[(is.na(mes_5==5)!=TRUE & mes_5==5 & is.na(ingresos$ing_5)!=TRUE)]=ingresos$ing_5[(is.na(mes_5==5)!=TRUE & mes_5==5 & is.na(ingresos$ing_5)!=TRUE)]/may16
ingresos$ing_5[(is.na(mes_5==6)!=TRUE & mes_5==6 & is.na(ingresos$ing_5)!=TRUE)]=ingresos$ing_5[(is.na(mes_5==6)!=TRUE & mes_5==6 & is.na(ingresos$ing_5)!=TRUE)]/jun16
ingresos$ing_5[(is.na(mes_5==7)!=TRUE & mes_5==7 & is.na(ingresos$ing_5)!=TRUE)]=ingresos$ing_5[(is.na(mes_5==7)!=TRUE & mes_5==7 & is.na(ingresos$ing_5)!=TRUE)]/jul16

ingresos$ing_4[(is.na(mes_4==4)!=TRUE & mes_4==4 & is.na(ingresos$ing_4)!=TRUE)]=ingresos$ing_4[(is.na(mes_4==4)!=TRUE & mes_4==4 & is.na(ingresos$ing_4)!=TRUE)]/abr16
ingresos$ing_4[(is.na(mes_4==5)!=TRUE & mes_4==5 & is.na(ingresos$ing_4)!=TRUE)]=ingresos$ing_4[(is.na(mes_4==5)!=TRUE & mes_4==5 & is.na(ingresos$ing_4)!=TRUE)]/may16
ingresos$ing_4[(is.na(mes_4==6)!=TRUE & mes_4==6 & is.na(ingresos$ing_4)!=TRUE)]=ingresos$ing_4[(is.na(mes_4==6)!=TRUE & mes_4==6 & is.na(ingresos$ing_4)!=TRUE)]/jun16
ingresos$ing_4[(is.na(mes_4==7)!=TRUE & mes_4==7 & is.na(ingresos$ing_4)!=TRUE)]=ingresos$ing_4[(is.na(mes_4==7)!=TRUE & mes_4==7 & is.na(ingresos$ing_4)!=TRUE)]/jul16
ingresos$ing_4[(is.na(mes_4==8)!=TRUE & mes_4==8 & is.na(ingresos$ing_4)!=TRUE)]=ingresos$ing_4[(is.na(mes_4==8)!=TRUE & mes_4==8 & is.na(ingresos$ing_4)!=TRUE)]/ago16

ingresos$ing_3[(is.na(mes_3==5)!=TRUE & mes_3==5 & is.na(ingresos$ing_3)!=TRUE)]=ingresos$ing_3[(is.na(mes_3==5)!=TRUE & mes_3==5 & is.na(ingresos$ing_3)!=TRUE)]/may16
ingresos$ing_3[(is.na(mes_3==6)!=TRUE & mes_3==6 & is.na(ingresos$ing_3)!=TRUE)]=ingresos$ing_3[(is.na(mes_3==6)!=TRUE & mes_3==6 & is.na(ingresos$ing_3)!=TRUE)]/jun16
ingresos$ing_3[(is.na(mes_3==7)!=TRUE & mes_3==7 & is.na(ingresos$ing_3)!=TRUE)]=ingresos$ing_3[(is.na(mes_3==7)!=TRUE & mes_3==7 & is.na(ingresos$ing_3)!=TRUE)]/jul16
ingresos$ing_3[(is.na(mes_3==8)!=TRUE & mes_3==8 & is.na(ingresos$ing_3)!=TRUE)]=ingresos$ing_3[(is.na(mes_3==8)!=TRUE & mes_3==8 & is.na(ingresos$ing_3)!=TRUE)]/ago16
ingresos$ing_3[(is.na(mes_3==9)!=TRUE & mes_3==9 & is.na(ingresos$ing_3)!=TRUE)]=ingresos$ing_3[(is.na(mes_3==9)!=TRUE & mes_3==9 & is.na(ingresos$ing_3)!=TRUE)]/sep16

ingresos$ing_2[(is.na(mes_2==6)!=TRUE & mes_2==6 & is.na(ingresos$ing_2)!=TRUE)]=ingresos$ing_2[(is.na(mes_2==6)!=TRUE & mes_2==6 & is.na(ingresos$ing_2)!=TRUE)]/jun16
ingresos$ing_2[(is.na(mes_2==7)!=TRUE & mes_2==7 & is.na(ingresos$ing_2)!=TRUE)]=ingresos$ing_2[(is.na(mes_2==7)!=TRUE & mes_2==7 & is.na(ingresos$ing_2)!=TRUE)]/jul16
ingresos$ing_2[(is.na(mes_2==8)!=TRUE & mes_2==8 & is.na(ingresos$ing_2)!=TRUE)]=ingresos$ing_2[(is.na(mes_2==8)!=TRUE & mes_2==8 & is.na(ingresos$ing_2)!=TRUE)]/ago16
ingresos$ing_2[(is.na(mes_2==9)!=TRUE & mes_2==9 & is.na(ingresos$ing_2)!=TRUE)]=ingresos$ing_2[(is.na(mes_2==9)!=TRUE & mes_2==9 & is.na(ingresos$ing_2)!=TRUE)]/sep16
ingresos$ing_2[(is.na(mes_2==10)!=TRUE & mes_2==10 & is.na(ingresos$ing_2)!=TRUE)]=ingresos$ing_2[(is.na(mes_2==10)!=TRUE & mes_2==10 & is.na(ingresos$ing_2)!=TRUE)]/oct16

ingresos$ing_1[(is.na(mes_1==7)!=TRUE & mes_1==7 & is.na(ingresos$ing_1)!=TRUE)]=ingresos$ing_1[(is.na(mes_1==7)!=TRUE & mes_1==7 & is.na(ingresos$ing_1)!=TRUE)]/jul16
ingresos$ing_1[(is.na(mes_1==8)!=TRUE & mes_1==8 & is.na(ingresos$ing_1)!=TRUE)]=ingresos$ing_1[(is.na(mes_1==8)!=TRUE & mes_1==8 & is.na(ingresos$ing_1)!=TRUE)]/ago16
ingresos$ing_1[(is.na(mes_1==9)!=TRUE & mes_1==9 & is.na(ingresos$ing_1)!=TRUE)]=ingresos$ing_1[(is.na(mes_1==9)!=TRUE & mes_1==9 & is.na(ingresos$ing_1)!=TRUE)]/sep16
ingresos$ing_1[(is.na(mes_1==10)!=TRUE & mes_1==10 & is.na(ingresos$ing_1)!=TRUE)]=ingresos$ing_1[(is.na(mes_1==10)!=TRUE & mes_1==10 & is.na(ingresos$ing_1)!=TRUE)]/oct16
ingresos$ing_1[(is.na(mes_1==11)!=TRUE & mes_1==11 & is.na(ingresos$ing_1)!=TRUE)]=ingresos$ing_1[(is.na(mes_1==11)!=TRUE & mes_1==11 & is.na(ingresos$ing_1)!=TRUE)]/nov16
...
ingresos$ing_1[is.na(ingresos$ing_1)!=TRUE & ingresos$clave=="P008"]= ingresos$ing_1[is.na(ingresos$ing_1)!=TRUE & ingresos$clave=="P008"]/may16/12
ingresos$ing_1[is.na(ingresos$ing_1)!=TRUE & ingresos$clave=="P015"]= ingresos$ing_1[is.na(ingresos$ing_1)!=TRUE & ingresos$clave=="P015"]/may16/12

ingresos$ing_1[is.na(ingresos$ing_1)!=TRUE & ingresos$clave=="P009"]= ingresos$ing_1[is.na(ingresos$ing_1)!=TRUE & ingresos$clave=="P009"]/dic15/12
...
attach(ingresos)
ingresos2=aggregate(x=list(ing_mon1), by=list( folioviv, foliohog),  FUN=sum, na.rm=TRUE)
detach(ingresos)
...
nomonetariopersona <- read.dbf("Bases de datos/gastospersona.dbf",as.is = TRUE)
...
nomonetariohogar <- read.dbf("Bases de datos/gastoshogar.dbf",as.is = TRUE)
...
salud=read.csv('Bases/ic_asalud16.csv',header=TRUE, sep=",", na.strings="NA", dec=".")
base_pobreza= merge(rezedu, salud,by.x=c( "folioviv", "foliohog", "numren" ), all.x = TRUE)
segsoc=read.csv('Bases/ic_segsoc16.csv',header=TRUE, sep=",", na.strings="NA", dec=".")
base_pobreza= merge(base_pobreza, segsoc, by.x=c( "folioviv", "foliohog", "numren" ), all.x = TRUE)
ingresos=read.csv('Bases/p_ingresos16.csv', header=TRUE, sep=",", na.strings="NA", dec=".")
base_pobreza= merge(base_pobreza, ingresos, by.x=c( "folioviv", "foliohog"), all.x = TRUE)
cev=read.csv('Bases/ic_cev16.csv',header=TRUE, sep=",", na.strings="NA", dec=".")
base_pobreza= merge(base_pobreza, cev, by.x=c( "folioviv", "foliohog"), all.x = TRUE)
sbv=read.csv('Bases/ic_sbv16.csv',header=TRUE, sep=",", na.strings="NA", dec=".")
base_pobreza= merge(base_pobreza, sbv, by.x=c( "folioviv"), all.x = TRUE)
ali=read.csv('Bases/ic_ali16.csv',header=TRUE, sep=",", na.strings="NA", dec=".")
...
base_pobreza=base_pobreza[, c("folioviv" ,	"foliohog" ,	"numren" ,	"edad" ,	"anac_e" ,	"inas_esc" ,	
                              "antec_esc" ,	"niv_ed" ,	"ic_rezedu" ,	"hli" ,	"sexo" ,	"discap" ,	
                              "ic_asalud" ,	"pea" ,	"jub" ,	"ss_dir" ,	"par" ,	"jef_ss" ,	"cony_ss" ,	"hijo_ss" ,	
                              "s_salud" ,	"pam" ,	"ic_segsoc" ,	"factor" ,	"tam_loc" ,	"rururb" ,	"tamhogesc" ,	
                              "ict" ,	"ictpc" ,	"plb_m" ,	"plb" ,	"tot_resid" ,	"num_cuarto" ,	"icv_pisos" ,	
                              "icv_techos" ,	"icv_muros" ,	"icv_hac" ,	"ic_cv" ,	"isb_agua" ,	"isb_dren" ,	
                              "isb_luz" ,	"isb_combus" ,	"ic_sbv" ,	"id_men" ,	"ia_1ad" ,	"ia_2ad" ,	"ia_3ad" ,	
                              "ia_4ad" ,	"ia_5ad" ,	"ia_6ad" ,	"ia_7men" ,	"ia_8men" ,	"ia_9men" ,	"ia_10men" ,	
                              "ia_11men" ,	"ia_12men" ,	"tot_iaad" ,	"tot_iamen" ,	"ins_ali" ,	"ic_ali" ,	"ent" ,	
                              "i_privacion" ,	"pobreza" ,	"pobreza_e" ,	"pobreza_m" ,	"vul_car" ,	"vul_ing" ,	"no_pobv" ,	
                              "carencias" ,	"carencias3" ,	"cuadrantes" ,	"prof_b1" ,	"prof_bm1" ,	"profun" ,	"int_pob" ,	
                              "int_pobe" ,	"int_vulcar" ,	"int_caren" )]
